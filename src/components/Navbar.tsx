...
export default function NavBar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 bg-indigo-500 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500  ${
        isScrolled
        ...
        <div className="relative flex items-center border pl-3 gap-2 bg-white border-gray-500/30  rounded-md  max-w-md w-full h-[60px]">
          ...
          <div className=" w-full h-[40px] ">
            <input
              ...
              className={`w-[300px] h-full outline-none text-gray-500 transition-all  duration-600 placeholder-gray-500 text-sm`}
            />
