...
const Cart = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="min-h-screen my-20 bg-gray-900 p-4 font-sans text-gray-200 antialiased flex items-center justify-center">
        <div className="mx-auto max-w-4xl  rounded-3xl bg-gray-800 p-6 shadow-2xl flex flex-col ">
